...
public class Tableta extends ElectronicDevice implements Bateria, Wifi {

    public static final String type = "Tableta";
    ...
    private int capacidad = 4000;
    private int porcentaje_carga = 60;
