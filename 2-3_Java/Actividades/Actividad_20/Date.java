...
public class Date {
    ...
    public Date(int year, int month, int day) throws OutOfRange{
        if (isValid(year, month, day)) {
            ...
            FIRST_MONTH = c0.get(Calendar.MONTH) + 1;
            FIRST_DAY = c0.get(Calendar.DAY_OF_MONTH);
            throw new OutOfRange(year, month, day);
        }
    ...
    // __________________________________________________________________________
    public void setDate(int year, int month, int day) throws OutOfRange{
        if (isValid(year, month, day)) {
            this.year = year;
            this.month = month;
            this.day = day;
    ...
    public void setMonth(int month) throws OutOfRange{
        if (month >=1 && month <= 12)
            ...
            throw new OutOfRange(month);
    }

    public void setDay(int day) throws OutOfRange{
        if (day >=1 && day <= daysPerMonth(getYear(), getMonth()))
            setDate(year, month, day);
        else 
            throw new OutOfRange(month);
    }
