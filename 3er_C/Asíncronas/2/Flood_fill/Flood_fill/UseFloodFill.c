...
int main(void) {
    ...
    switch (choice) {
        case 1:
            recursiveFloodFill(matrix, x, y, matrix[x][y], numDeReemplazo);
            break;
        case 2:
            stackFloodFill(matrix, x, y, matrix[x][y], numDeReemplazo);
            break;
        case 3:
            queueFloodFill(matrix, x, y, matrix[x][y], numDeReemplazo);
            break;
        case 0:
            break;
        default:
